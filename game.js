...
var BOSS = [
  ...
  {t:'sp'},
  {t:'switch-gun'},
  {t:'dlg',  sp:'빅보스 (데빌 게임즈)', tx:'그런데… 미안.', red:true},
  {t:'dlg',  sp:'빅보스 (데빌 게임즈)', tx:'증인은 남길 수 없거든.', red:true},
...
function calcResult(){
  ...
  var gBodies = {
    ...
    C: '데빌 게임즈는 \'올해의 기업\'으로 선정되었습니다. 일루셔니스트 게임즈는 주가 하락과 시장 점유율 감소를 기록 중입니다. 합리적으로 보이는 함정을 반복해서 선택한 결과입니다.',
    D: '데빌 게임즈는 \'올해의 기업\'으로 선정되며 눈부신 성과를 달성했고, 한편 쌍두마차였던 일루셔니스트 게임즈는 경영난을 극복하지 못하고 상장폐지 위기에 놓였습니다.'
  };
