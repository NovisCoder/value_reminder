...
var BOSS = [
  ...
  {t:'line', tx:'소울컴퍼니 빅보스가 기다리고 있다.'},
  {t:'line', tx:'클루 10개를 모두 전달했다.'},
  {t:'dlg',  sp:'빅보스 (소울컴퍼니)', tx:'수고했어. 이번엔 끝났어. 역시 믿을 만해.'},
  {t:'sp'},
  {t:'switch-gun'},
  {t:'dlg',  sp:'빅보스 (소울컴퍼니)', tx:'그런데… 미안.', red:true},
  {t:'dlg',  sp:'빅보스 (소울컴퍼니)', tx:'증인은 남길 수 없거든.', red:true},
  {t:'line', tx:'"살려줘요—!"', red:true},
...
var AWAKE = [
  ...
  {t:'line', tx:'"꿈에서 소울컴퍼니 스파이가 되어 수집했던\n킨더조이 회사의 약점들…\n사실 그게 내가 대표로서 해결해야 할 우리 회사 과제들이었던 거야."'},
...
function calcResult(){
  ...
  var gBodies = {
    S: '킨더조이 컴퍼니, 업계 최초 2년 연속 \'올해의 기업\' 선정. ' + G.name + ' 사장의 결단력 있는 혁신 추진이 업계의 주목을 받았습니다. PHOENIX 프로젝트는 출시 6개월 만에 시장 점유율 1위를 달성했습니다.',
    A: '킨더조이 컴퍼니가 \'올해의 기업\'으로 선정되며 눈부신 성과를 달성했습니다. ' + G.name + ' 사장이 이끈 킨더조이는 내부 혁신 과제를 하나씩 해결하며 업계 신뢰를 회복했습니다.',
    B: '킨더조이는 올해 위기를 넘겼습니다. 하지만 \'올해의 기업\'은 소울컴퍼니가 차지했습니다. 일부 과제는 방향이 맞았지만, 핵심 결정들에서 익숙한 선택을 반복했습니다.',
